"""
Django settings for battlants_42834 project.
...
ROOT_URLCONF = 'battlants_42834.urls'
...
WSGI_APPLICATION = 'battlants_42834.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "battlants_42834 API",
    "DESCRIPTION": "API documentation for battlants_42834 App",
    "VERSION": "v1",
}
